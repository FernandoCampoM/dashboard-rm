...
function loadCalendar(){
    ...
    calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        select: function (info) {
            ...
            // Mostrar el modal (getOrCreateInstance evita apilar múltiples instancias)
        ...
        eventClick: function (info) {
            ...
            // Abrimos el modal (getOrCreateInstance evita apilar múltiples instancias)
            const modalElement = document.getElementById("eventModal");
            const modalInstance = bootstrap.Modal.getOrCreateInstance(modalElement);
            modalInstance.show();
        },
...
function abrirModalHorario(horario = null) {
    ...
    const modal = bootstrap.Modal.getOrCreateInstance(document.getElementById("modalHorario"));
