...
<div class="modal fade" id="recibirProductoModal" tabindex="-1" aria-labelledby="recibirProductoLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">

      <div class="modal-header">
        <h5 class="modal-title" id="recibirProductoLabel">Pre-Orden / Recibir Inventario</h5>
      ...
      <div class="modal-body">
        <div id="movementContainer">
          ...
          <div class="row">
            ...
            <div class="order-suggestion-section col-md-6">
              ...
              <p class="text-end text-danger mb-0" style="font-size: 10px;"><span
                  id="suggested-order-excess-message">*producto en exceso para cubrir 6 meses</span></p>
        ...
        <div class="card p-4 shadow-sm">
          ...
          <div class="text-center display-3 fw-bold mb-3">
            <input type="number" id="cantidadProducto" class="form-control text-center display-3 fw-bold" value="1"
              min="1">
          </div>
